...
export const ticketsMock: TicketMock[] = Array.from({ length: 24 }).map((_, i) => {
  const statuses: TicketStatus[] = ["ABERTO", "AGUARDANDO", "CONCLUIDO", "CANCELADO"];
  const cats = ["Internet", "CFTV", "Notebook/Desktop", "Sistema EVO", "Som", "Catraca"];
...
export const usuariosMock: UsuarioMock[] = [
  { id: "U-01", nome: "Ana Lima", email: "ana@evoque.com", perfil: "Administrador" },
  { id: "U-02", nome: "Bruno Alves", email: "bruno@evoque.com", perfil: "Agente" },
  { id: "U-03", nome: "Carla Souza", email: "carla@evoque.com", perfil: "Padrão", bloqueado: true },
  { id: "U-04", nome: "Daniel Reis", email: "daniel@evoque.com", perfil: "Agente" },
];

export interface UnidadeMock { id: string; nome: string; cidade: string }
