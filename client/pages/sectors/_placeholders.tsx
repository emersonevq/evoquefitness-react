    ...
    <Layout>
      ...
      <section className="container py-8">
        <div className="rounded-xl border border-border/60 bg-card p-6 sm:p-8">
          <p className="text-muted-foreground">Conteúdo deste setor será adicionado conforme sua orientação.</p>
        </div>
      </section>
    </Layout>
  );
...
export const OutrosServicosPage = () => <SectorPlaceholder slug="outros-servicos" />;
